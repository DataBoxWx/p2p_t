            ...
            <div class="eachInvest invest-tab invest-tab-box">
                ...
                <dl>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach items="${rechargeRecordList}" var="rechargeRecord" varStatus="seri">
                                <dd>
                                    <span class="name">${seri.count}</span>
            ...
            <div class="eachInvest recent-earnings">
                ...
                <dl id="recentearning">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach items="${incomeRecordList}" var="incomeRecord" varStatus="seq">
                                <dd>
                                    <span class="number" style="text-align:left;">${seq.count}</span>
